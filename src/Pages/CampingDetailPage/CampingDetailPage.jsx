            ...
            {data?.map((item) => (
                <>
                    ...
                    <div className='DetailInfoContainer'>
                        ...
                        <div className='answerInfo'>{item.intro?<div>{item.intro}</div> : <div> 자세한 정보가 나와있지 않아요ㅠ </div>}</div>
                        <h4 className='DetailIntroTitle'>어떤 특징을 가지고 있나요?</h4>
                        <div className='answerInfo'>{item.lineIntro?<div>{item.lineIntro}</div> : <div> 자세한 정보가 나와있지 않아요ㅠ </div>}</div>
                        ...
                        <h4 className='DetailIntroTitle'><img className = "dogImage"src={dog}/> 반려동물과 함께 사용할 수 있나요?</h4>
                        <div className='answerInfo'>{item.animalCmgCl} 합니다.</div>
                    </div>
                    <div className='EtcInfoContainer'>
                        <h4>기타 정보</h4>
                        <div className='EtcList'>
                            <div>에약 방법 : {item.resveCl?<>{item.resveCl}</>: '자세한 정보가 나와있지 않아요.'}</div>
